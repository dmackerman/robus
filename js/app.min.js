...
(function(a) {
    ...
    app.SetView = Backbone.View.extend({
        ...
        addSet: function() {
            ...
            app.Sets.create(a);
            var b = new app.SetView({
                model: a
            });
            this.$el.parent().append(b.render().el);
        },
        saveSetData: function(b) {
            var c = b.target.name;
            "weight" == c && this.model.set({
                weight: a("#" + this.model.cid + " input[name=weight]").val()
            }), "reps" == c && this.model.set({
                reps: a("#" + this.model.cid + " input[name=reps]").val()
            }), this.model.save();
        }
    });
})(Zepto);
...
(function() {
    ...
    app.SetListView = Backbone.View.extend({
        ...
        initialize: function() {
            this.setsInThisExercise = app.Sets.where({
        ...
        render: function() {
            if (0 == this.setsInThisExercise.length) {
                ...
                app.Sets.create(a), this.$el.append(b.render().el);
            } else _.each(this.setsInThisExercise, this.addSetView, this);
            return this;
        },
        addSetView: function(a) {
            var b = new app.SetView({
                model: a,
                weight: a.get("weight"),
                reps: a.get("reps"),
...
(function() {
    ...
    app.Workouts.fetch({
        success: function() {
            ...
            app.Router.renderView(a), app.Router.navigate("home"), app.Exercises.fetch(), app.Sets.fetch();
        }
    });
})(Zepto);