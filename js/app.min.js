...
(function(a) {
    ...
    app.ExerciseView = Backbone.View.extend({
        ...
        initialize: function() {
            this.model.on("change", this.render, this), this.model.on("destroy", this.removeExercise, this);
        },
        render: function() {
            return this.$el.html(this.template(this.model.toJSON())), this;
        },
        deleteExercise: function(a) {
            a.stopPropagation(), console.log(a.isPropagationStopped()), this.model.destroy();
        },
        ...
        showExercises: function() {
            ...
            var a = new app.ExerciseDetailView({
                model: this.model,
...
(function() {
    ...
    app.ExercisesListView = Backbone.View.extend({
        ...
        className: "list",
        initialize: function(a) {
            this.workout = a.workout, this.exercisesInWorkout = this.collection.where({
                workout: this.workout
            }), this.listenTo(this.collection, "add", this.addExercise);
        },
        render: function() {
            return _.each(this.exercisesInWorkout, this.addExercise, this), this;
        },
...
(function() {
    ...
    app.SetView = Backbone.View.extend({
        ...
        render: function() {
            ...
            return this.$el.append(a.render().el), this;
        }
    });
})(Zepto);
...
(function(a) {
    ...
    app.WorkoutView = Jr.View.extend({
        ...
        initialize: function() {
            this.model.on("change", this.render, this), this.model.on("destroy", this.removeWorkout, this);
        },
        render: function() {
            return this.$el.html(this.template(this.model.toJSON())), this;
        },
...
(function() {
    ...
    app.WorkoutsListView = Jr.View.extend({
        ...
        render: function() {
            return this.collection.each(this.addWorkout, this), this;
        },
        addWorkout: function(a) {
            var b = new app.WorkoutView({
                model: a
            });
            this.$el.append(b.render().el), this.remove();
        }
    });
})(Zepto);
...
(function(a) {
    ...
    app.HomeView = Backbone.View.extend({
        ...
        clearLocalStorage: function(a) {
            console.log("cleared localstorage"), a.preventDefault(), localStorage.clear();
        }
    });
})(Zepto);
...
(function() {
    ...
    }), app.Router = new app.AppRouter(), Backbone.history.start();
})();
