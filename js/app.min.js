...
(function() {
    ...
    app.ExercisesListView = Backbone.View.extend({
        ...
        render: function() {
            return 0 == this.exercisesInWorkout.length ? this.$el.append('<li class="empty"><strong>No exercises!</strong><br /> Add one.</li>') : _.each(this.exercisesInWorkout, this.addExercise, this), 
            this;
        },
