...
(function(a) {
    ...
    app.AddWorkoutView = Backbone.View.extend({
        ...
        submit: function(b) {
            ...
            this.collection.create(d), console.log(this.collection), Jr.Navigator.navigate("workouts", {
                trigger: !0,
                animation: {
...
(function(a) {
    ...
    app.ExercisesView = Jr.View.extend({
        ...
        initialize: function() {
            app.Exercises.fetch({
                success: function() {
                    console.log(new app.ExercisesListView({
...
(function() {
    ...
    }), new app.AppRouter(), Backbone.history.start();
})();
